...
Four documents now govern ALL speed and training-method work on the V5 track. Read them
...
`reports/v5_alpha_holdem_takeover_handoff_20260709.md`, and
`reports/v5_alpha_holdem_takeover_handoff_20260709.json`.

Current direction: EXP-002 is adopted and retained; EXP-003 is running from
gate 21800 / 358,064,575 hands and must remain the only behavior-affecting
change until its first PASS checkpoint at or above 408,064,575 hands. EXP-004
is held at the stable preflop/postflop prior floor 0.01/0.02; zero prior is not
authorized. The EXP-003 judgment must follow
`reports/v5_exp003_judgment_protocol_20260709.md` and use a frozen three-role
causal bundle; one valid candidate-vs-anchor measurement is not a method
success. Always refresh the live run artifacts before acting.

The older `v5_alpha_holdem_takeover_handoff_20260706_1224.*` files and the
