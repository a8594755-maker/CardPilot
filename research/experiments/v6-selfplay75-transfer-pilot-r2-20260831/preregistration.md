# Matched corrected-v6 self-play share transfer pilot
...
harness sibling-module import path, uses new r2 run IDs, and reuses the still
...
python research/experiments/v6-selfplay75-transfer-pilot-r2-20260831/run_pilot.py
