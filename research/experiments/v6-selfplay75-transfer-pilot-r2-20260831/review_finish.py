...
def main():
    ...
    for label in ['control25','selfplay75']:
        ...
        assert account['origin_run_id'] == checkpoint['run_id'] == f'v6_selfplay_share_r2_{label}_20260831'
    ...
    pilot.log('--command','python research/experiments/v6-selfplay75-transfer-pilot-r2-20260831/review_finish.py',
