...
ORDER=((1,'control'),(1,'expanded'),(3,'control'),(3,'expanded'))
def logger(*args):
...
def command(seed,arm,config):
    ...
    parent=str(BASE.parent/'v6-opponent-execution-mixture-two-seed-geometric-20260907'/f'seed{seed}_control_stage2/latest.pt')
    ...
    return argv+['--pairs-per-anchor','1024','--seed',str(20266401+10*seed),'--device','cuda','--out-dir',str(BASE/f'eval_seed{seed}_{arm}')]
class Controller:
