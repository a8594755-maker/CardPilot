...
def main():
    ...
    for seed,arm in t.ORDER:
        ...
        parent=str(t.BASE.parent/'v6-opponent-execution-mixture-two-seed-geometric-20260907'/f'seed{seed}_control_stage2/latest.pt')
        binding={'path':parent,'sha256':reviewed['input_sha256'][parent]}
    ...
    for seed in (1,3):
        for index in range(5):
            rng=random.Random(20266401+10*seed+1000003*index)
            for _ in range(1024):
