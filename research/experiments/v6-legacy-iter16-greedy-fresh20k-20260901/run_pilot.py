"""Eight fixed fresh2500 exact-iter16 legacy-bridge greedy Slumbot sessions."""
...
def load_parent():
    spec = importlib.util.spec_from_file_location("iter16_fixed_fresh20k_parent", PARENT)
...
def session_id(index):
    return f"v6_legacy_iter16_greedy_fresh20k_20260901_s{index:02d}"


def session_seed(index):
    return 2026113000 + index
