"""Raw-hand and equal-session statistics for exact iter16 fresh20k confirmation."""
import math
import statistics

T7 = 2.3646242515927853
PRIOR_FRESH5K_BB100 = 19.46
...
def summarize(sessions, hands_per_session=2500):
    ...
    return {
        ...
        "prior_fresh5k_bb_per_100": PRIOR_FRESH5K_BB100,
        "parent_bridge_fresh20k_bb_per_100": PARENT_BRIDGE_FRESH20K_BB100,
        "point_delta_vs_prior_fresh5k": mean - PRIOR_FRESH5K_BB100,
