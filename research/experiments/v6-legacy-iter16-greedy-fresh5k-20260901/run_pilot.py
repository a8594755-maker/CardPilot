"""Eight fixed fresh625 exact-iter16 legacy-bridge greedy Slumbot sessions."""
...
SOURCE = ROOT / "research/experiments/v6-legacy-contract-mixed-league-65k-pilot-20260901/training/checkpoints/checkpoint_iter000016_hands000000065966.pt"
SOURCE_SHA = "0b1b58a87637f620ae580754bc940ec7aca246d94762d77717c9b578aac9f290"
...
def load_parent():
    spec = importlib.util.spec_from_file_location("iter16_fixed_fresh5k_parent", PARENT_MODULE)
...
def session_id(index):
    return f"v6_legacy_iter16_greedy_fresh5k_20260901_s{index:02d}"


def session_seed(index):
    return 2026112900 + index
