"""Raw-hand and equal-session statistics for the exact iter16 fresh5k gate."""
import math
import statistics

T7 = 2.3646242515927853
PARENT_BRIDGE_FRESH20K_BB100 = -24.5683
PARENT_BRIDGE_FRESH5K_BB100 = -15.79
...
def summarize(sessions, hands_per_session=625):
    ...
    supports = mean > PARENT_BRIDGE_FRESH20K_BB100 and raw_ci[1] > 0 and positive_sessions >= 4
    return {
        ...
        "parent_bridge_fresh20k_bb_per_100": PARENT_BRIDGE_FRESH20K_BB100,
        "parent_bridge_fresh5k_bb_per_100": PARENT_BRIDGE_FRESH5K_BB100,
        "point_delta_vs_parent_fresh20k": mean - PARENT_BRIDGE_FRESH20K_BB100,
        "point_delta_vs_parent_fresh5k": mean - PARENT_BRIDGE_FRESH5K_BB100,
        "supports_separate_fresh20k": supports,
