"""Raw-hand and equal-session statistics for the bridge calibration."""
import math
import statistics

T7 = 2.3646242515927853
HISTORICAL_OLD_CONTRACT_GREEDY_BB100 = -11.4275
NAIVE_V6_REBOUND_FRESH5K_BB100 = -96.6832
...
def summarize(sessions, hands_per_session=625):
    ...
    return {
        ...
        "historical_old_contract_greedy_bb_per_100": HISTORICAL_OLD_CONTRACT_GREEDY_BB100,
        "naive_v6_rebound_fresh5k_bb_per_100": NAIVE_V6_REBOUND_FRESH5K_BB100,
        "point_delta_vs_historical_old_contract": mean - HISTORICAL_OLD_CONTRACT_GREEDY_BB100,
        "point_delta_vs_naive_v6_rebound": mean - NAIVE_V6_REBOUND_FRESH5K_BB100,
        "supports_separate_fresh20k": mean > -40.0 and raw_ci[1] > 0.0,
        "goal_achieved": False,
