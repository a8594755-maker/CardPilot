...
def main():
    ...
    sources += [HERE / 'launch_followthrough.ps1', HERE / 'naming_deviation_outcome_blind.md',
    ...
    earlier = review.r.read(template / 'followthrough_qualification_v2.json')
    ...
    hashes[str(template / 'followthrough_qualification_v2.json')] = review.r.sha(template / 'followthrough_qualification_v2.json')
