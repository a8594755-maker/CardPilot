# Frozen Standard10 native-sampled external baseline
...
-8sessions,2500requested hands each; seeds2026090501 through2026090508. Each new client starts without a Slumbot token. Start the next client only after the preceding client has one complete raw hand and a decision dump, plus1second stagger. Eight sessions is the maximum concurrent load.
