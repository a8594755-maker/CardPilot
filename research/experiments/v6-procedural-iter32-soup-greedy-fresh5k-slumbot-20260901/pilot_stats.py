"""Raw-hand and equal-eight-session statistics for the fixed fresh5k gate."""
...
def summarize(sessions, hands_per_session=625):
    ...
    if not math.isclose(
        mean, math.fsum(session_means) / 8, rel_tol=1e-12, abs_tol=1e-12
    ):
    ...
    return {
        ...
        "raw_parent_historical_bb_per_100": RAW_PARENT_BB_PER_100,
        "point_delta_vs_raw_parent_historical": mean - RAW_PARENT_BB_PER_100,
