...
def training_command(label):
    ...
    for flag, value in {'--total-environment-hands':TARGET, '--run-id':f'v6_selfplay_share_{label}_20260831',
...
def training_health(label):
    ...
    assert account['origin_run_id'] == f'v6_selfplay_share_{label}_20260831'
