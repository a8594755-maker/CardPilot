...
def main():
    ...
    if args.opponent_greedy_mixture != .5:
        raise ValueError('this fixed qualification requires mixture .5')
    ...
    runtime = {'schema':'opponent_mixture.runtime.v1', 'greedy_weight':.5,
    ...
    trainer, binding, _ = module.install(.5)
    argv = list(sys.argv)
