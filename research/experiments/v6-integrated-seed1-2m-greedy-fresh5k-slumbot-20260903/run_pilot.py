"""Eight fixed fresh625 Seed1-2M legacy-bridge Slumbot sessions."""
...
SOURCE = ROOT / "research/experiments/v6-integrated-alphaholdem-two-seed-2m-scale-20260903/seed1/latest.pt"
...
def load_parent():
    spec = importlib.util.spec_from_file_location("integrated_seed1_2m_fresh5k_parent", PARENT_MODULE)
...
def session_id(index):
    return f"v6_integrated_seed1_2m_greedy_fresh5k_20260903_s{index:02d}"


def session_seed(index):
    return 2026263200 + index
