...
STANDARD10_GREEDY_BB_PER_100 = -11.4275
...
def summarize(sessions, hands_per_session=625):
    ...
    return {
        ...
        "standard10_historical_greedy_bb_per_100": STANDARD10_GREEDY_BB_PER_100,
        "point_delta_vs_standard10_historical": mean - STANDARD10_GREEDY_BB_PER_100,
