"""Independent raw-hand/evidence review for the source-KL-temperature fresh5k."""
...
MODEL_SHA = "9e1566812f6550415be4d7d90b21180080a8c3f6f9b0096457a04a98a54b0847"
...
def main():
    ...
    for index in range(1, 9):
        ...
        assert all(
            ...
            and row["policy_seed"] == 2026111900 + index
    ...
    (BASE / "result_summary.md").write_text(
        "# Source-KL-temperature generic-greedy fresh5k\n\n"
        ...
        f"{statistics['positive_sessions']}/8. Historical unpaired delta versus Standard10 "
        f"{statistics['point_delta_vs_standard10_historical']:+.6f} bb/100. All actions were "
