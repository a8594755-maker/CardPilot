...
def main():
    ...
    try:
        ...
        inputs=[PARENT/'reviewed_analysis.json',SOURCE/'reservoir.pt',PARENT/'training_relabel/reach_targets.npy',
            ...
            SOURCE/'initializer.pt',PARENT/'checkpoints/epoch01.pt',PARENT/'checkpoints/epoch04.pt',PARENT/'latest.pt']
        ...
        checkpoints={0:SOURCE/'initializer.pt',1:PARENT/'checkpoints/epoch01.pt',4:PARENT/'checkpoints/epoch04.pt',8:PARENT/'latest.pt'}
        train={}
