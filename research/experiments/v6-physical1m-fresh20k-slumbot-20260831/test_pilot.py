...
def test_exact_fresh_commands():
    ...
    for i,c in enumerate(commands,1):
        assert c[c.index('--seed')+1]==str(2026100400+i)
        assert c[c.index('--session-id')+1]==f'v6_physical1m_fresh20k_20260831_s{i:02d}'
...
def test_readiness_prerequisites_without_network():
    ...
    assert run.MODEL_SHA=='bc4f62257a474ad438cd574d4c59b28ea009060749f0fb86e3e97c46120d0172'
