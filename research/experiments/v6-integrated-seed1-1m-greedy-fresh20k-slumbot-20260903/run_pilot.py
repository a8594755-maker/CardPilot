"""Eight fixed fresh2500 integrated-policy legacy-bridge Slumbot sessions."""
...
PARENT_MODULE = (
    ROOT
    / "research/experiments/v6-actor-raw-greedy-fresh20k-slumbot-20260901/run_pilot.py"
)
SOURCE = (
    ROOT
    / "research/experiments/v6-integrated-seed1-1m-greedy-fresh5k-slumbot-20260903/frozen/final.pt"
)
...
def load_parent():
    spec = importlib.util.spec_from_file_location("integrated_fresh20k_parent", PARENT_MODULE)
...
def session_id(index):
    return f"v6_integrated_seed1_1m_greedy_fresh20k_20260903_s{index:02d}"


def session_seed(index):
    return 2026263100 + index
