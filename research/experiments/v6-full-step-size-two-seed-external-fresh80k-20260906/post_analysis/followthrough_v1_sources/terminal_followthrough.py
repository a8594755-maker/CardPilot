...
def wait_for_owner(expected, live=None, read_execution=None, pause=None):
...
def validate_qualification():
    ...
    follow = r.read(HERE / 'followthrough_qualification.json')
    ...
    r.protocol.require(r.sha(HERE / 'followthrough_tests.xml') == follow['xml_sha256'], 'followthrough tests changed')
