...
spec = importlib.util.spec_from_file_location('strict_completed_review', BASE/'review_completed_pilot.py')
...
def test_only_complete_20k_can_admit():
    ...
    assert review.decision(dict(hands=20000, bb_per_100=0)) == 'SAMPLED_CANDIDATE_NONPOSITIVE'
