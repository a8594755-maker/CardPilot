...
def main():
    ...
    for index, line in enumerate(data.splitlines()):
        ...
        previous = digest
        deck, teachers = hand_spec(2026101501, index, 2)
        assert row['seed'] == 2026101501 and row['index'] == index and row['deck'] == deck and row['teachers'] == teachers
        ...
        for event in row['events']:
            ...
            uniform = uniform_for(2026101501, index, seat, counts[seat])
