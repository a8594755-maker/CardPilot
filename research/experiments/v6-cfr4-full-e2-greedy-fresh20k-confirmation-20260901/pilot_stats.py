"""Raw-hand and equal-session statistics for corrected-CFR4 fresh20k."""
import math
import statistics

T7 = 2.3646242515927853
PRIOR_FRESH4999_BB100 = -9.435887177435486
STANDARD10_BRIDGE_FRESH20K_BB100 = -24.5683
STANDARD10_HISTORICAL_FRESH20K_BB100 = -11.4275
...
def summarize(sessions, hands_per_session=2500):
    ...
    supports = mean > 0 and raw_ci[1] > 0 and positive_sessions >= 4
    return {
        ...
        "prior_fresh4999_bb_per_100": PRIOR_FRESH4999_BB100,
        "standard10_bridge_fresh20k_bb_per_100": STANDARD10_BRIDGE_FRESH20K_BB100,
        "standard10_historical_fresh20k_bb_per_100": STANDARD10_HISTORICAL_FRESH20K_BB100,
        "point_delta_vs_prior_fresh4999": mean - PRIOR_FRESH4999_BB100,
        "point_delta_vs_standard10_bridge": mean - STANDARD10_BRIDGE_FRESH20K_BB100,
        "point_delta_vs_standard10_historical": mean - STANDARD10_HISTORICAL_FRESH20K_BB100,
