"""Admission tests for rebound Standard10 current-v6 greedy calibration."""
...
os.environ["JOURNAL_TEST_OUTPUT"] = str(
    Path(tempfile.gettempdir()) / f"cardpilot_rebound_standard10_greedy_{uuid.uuid4().hex}"
)
...
def test_fixed_calibration_statistics():
