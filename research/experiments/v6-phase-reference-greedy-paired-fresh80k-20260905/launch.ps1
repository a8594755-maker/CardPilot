...
$pairController = Join-Path $researchWorkspace 'research\experiments\v6-phase-held-reference-control-20260904\recovery_20260905\external_preparation\run_pair.py'
