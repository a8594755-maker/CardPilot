"""Independent raw-hand review for the procedural-soup fresh20k."""
...
def main():
    ...
    assert analysis["decision"] == decision and not analysis["goal_achieved"]
    reviewed = {
        "status": "PASS",
        "decision": decision,
    ...
    (BASE / "result_summary.md").write_text(
        "# Preserved procedural-soup generic-greedy fresh20k\n\n"
        ...
        f"{statistics['positive_sessions']}/8. Historical unpaired delta versus fresh5k point "
        f"{statistics['point_delta_vs_fresh5k_historical']:+.6f} bb/100. These hands are not "
        "qualification hands and are not pooled.\n",
        encoding="utf-8",
    )
