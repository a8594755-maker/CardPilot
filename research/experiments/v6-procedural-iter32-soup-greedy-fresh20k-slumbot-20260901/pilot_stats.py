"""Raw-hand and equal-eight-session statistics for the fixed fresh20k gate."""
...
def summarize(sessions, hands_per_session=2500):
    ...
    return {
        ...
        "fresh5k_historical_bb_per_100": FRESH5K_BB_PER_100,
        "point_delta_vs_fresh5k_historical": mean - FRESH5K_BB_PER_100,
        "supports_separate_fresh100k": supports_fresh100k,
        # Compatibility key consumed by the inherited fixed-cohort runner. The
        # independent reviewer translates its generic label to fresh100k.
        "supports_separate_fresh20k": supports_fresh100k,
        "goal_achieved": False,
