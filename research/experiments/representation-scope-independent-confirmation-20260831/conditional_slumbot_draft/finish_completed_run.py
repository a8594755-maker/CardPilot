...
def main():
    ...
    subprocess.run([sys.executable, 'research/experiment_log.py', 'finish', BASE.name,
        ...
        '--summary', f'Exactly20000fresh strict native-sampled full-network hands: {summary["bb_per_100"]:+.4f}bb/100,95%CI[{summary["lower_bound_bb_per_100"]:+.4f},{summary["upper_bound_bb_per_100"]:+.4f}]. All8clients exited0; strict audit and independent chip-space review passed.',
