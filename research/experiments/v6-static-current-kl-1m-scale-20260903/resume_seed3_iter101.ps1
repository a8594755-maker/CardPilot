...
$preflightPath = "$experiment/seed3_resume_preflight_iter101.json"
...
if ([int64]$preflight.fixed_deal_recovery.deal_start_index -ne 32500000) {
...
$arguments = @(
    ...
    '--fixed-training-deal-start-index', '32500000',
...
if ($LASTEXITCODE -ne 0) {
    throw "Seed3 recovery continuation failed with exit code $LASTEXITCODE"
}
