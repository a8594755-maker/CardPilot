"""Preregistered raw-hand and equal-session statistics for 2M fresh20k."""
import math
import statistics
...
ADMISSION_FRESH5K_BB100 = -25.9712
...
def summarize(sessions, hands_per_session=2500):
    ...
    return {
        ...
        "admission_fresh5k_bb_per_100": ADMISSION_FRESH5K_BB100,
        ...
        "point_delta_vs_admission_fresh5k": mean - ADMISSION_FRESH5K_BB100,
        "supports_separate_fresh100k": (
            mean > 0.0 and raw_ci[1] > 0.0 and positive_sessions >= 4
        ),
        "goal_achieved": False,
