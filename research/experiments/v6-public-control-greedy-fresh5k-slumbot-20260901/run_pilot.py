"""Eight fixed fresh625 greedy Slumbot sessions for the shallow matched control."""
...
def session_id(index):
    return f"v6_public_control_greedy_fresh5k_20260901_s{index:02d}"


def session_seed(index):
    return 2026137000 + index
...
def main():
    ...
    def command(index):
        return [
            str(impl.CLIENT), "--model", str(BASE / "frozen/final.pt"),
