...
import { createShuffledDeck, parseCard } from "./card-utils.js";
 ...
 */
export function calculateHandStrength(heroHand, board) {
 ...
 */
export function outsToEquity(outs, streets) {
    if (streets === 1) {
...
function generateRandomOpponentHands(heroHand, board, count) {
