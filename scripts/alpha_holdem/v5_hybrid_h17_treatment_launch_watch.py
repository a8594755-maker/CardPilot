#!/usr/bin/env python3
"""H17 control endpoint watcher that exposes a safe no-trainer treatment boundary."""
from __future__ import annotations
import argparse,json,os,subprocess,time
from datetime import datetime,timezone
from pathlib import Path
RUN_ID='v5_hybrid_h17_treatment_catchsmoothl1b1_same35051_20m_r1_20260719'
def load(path):
...
def main():
 ...
 while True:
  ...
  endpoint=load(control/'h17_control_endpoint_status.json');protocol=load(control/'h17_control_protocol_status.json')
