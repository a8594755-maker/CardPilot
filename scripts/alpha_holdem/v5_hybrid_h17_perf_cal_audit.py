#!/usr/bin/env python3
"""Independent fail-closed audit for H17 representative PERF-CAL."""
...
from v5_hybrid_h17_perf_cal import (  # noqa: E402
...
def main() -> int:
    ...
    check(
        ...
        and artifact.get("classification") == "H17_REPRESENTATIVE_PERF_CAL_PASS",
    )
    ...
    payload = {
        "schema_version": "v5.hybrid.h17.representative_perf_cal_audit.v1",
