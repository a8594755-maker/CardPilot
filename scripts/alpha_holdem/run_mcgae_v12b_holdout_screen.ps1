...
$base = "models/slumbot_br_mcgae_v12b_conservative_524k_20260725/checkpoints"
$candidates = @(
    @{ Name = "iter2"; Checkpoint = "$base/checkpoint_iter000002_hands000000065649.pt" },
    @{ Name = "iter4"; Checkpoint = "$base/checkpoint_iter000004_hands000000131279.pt" },
    @{ Name = "iter6"; Checkpoint = "$base/checkpoint_iter000006_hands000000196922.pt" }
)
$opponents = @(
...
foreach ($candidate in $candidates) {
    $runName = "localgreedy_mcgae_v12b_holdout_$($candidate.Name)_65k_20260725"
