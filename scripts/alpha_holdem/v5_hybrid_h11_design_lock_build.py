#!/usr/bin/env python3
"""Build the one-shot immutable H11 design lock after all offline gates pass."""
...
PREREG = ROOT / "reports/v5_hybrid_h11_preregistration_20260715.json"
PREREG_AUDIT = ROOT / "reports/v5_hybrid_h11_preregistration_audit_20260715.json"
IMPLEMENTATION = ROOT / "reports/v5_hybrid_h11_implementation_audit_v2_20260715.json"
ROUTE_RESULT = ROOT / "reports/v5_hybrid_route_review_007_result_20260715.json"
ROUTE_AUDIT = ROOT / "reports/v5_hybrid_route_review_007_audit_20260715.json"
SOURCE = ROOT / "models/alpha_holdem_v5_hybrid/v5_hybrid_h8_treatment_kles003_vhcatch_same32617_20m_r1_20260714/h8_treatment_endpoint.pt"
MIRROR_DIR = ROOT / "reports/h11_mirror_001_20260715"
...
def main() -> int:
    ...
    if args.out.exists():
        raise SystemExit("refusing to overwrite immutable H11 design lock")
    prereg = load(PREREG)
    prereg_audit = load(PREREG_AUDIT)
    implementation = load(IMPLEMENTATION)
    route_audit = load(ROUTE_AUDIT)
    if sha(PREREG) != "d493b1f9e936d89f0c2e51a0b6c5dbc5a8dd20b312d5f9cd5e415f43f44528d0":
        raise SystemExit("preregistration hash")
    if prereg_audit.get("overall") != "PASS" or implementation.get("overall") != "PASS_H11_IMPLEMENTATION" or route_audit.get("overall") != "PASS":
    ...
    tools = [
        ...
        "scripts/alpha_holdem/v5_hybrid_h11_implementation_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h11_endpoint_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h11_protocol_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h11_treatment_launch_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h11_active_window.py",
        "scripts/alpha_holdem/v5_hybrid_h11_mirror.py",
        "scripts/alpha_holdem/v5_hybrid_h11_judge.py",
        "scripts/alpha_holdem/v5_hybrid_h11_completion_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h11_preflight.py",
        "scripts/alpha_holdem/v5_hybrid_h11_design_lock_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h11_launch_control.ps1",
        "scripts/alpha_holdem/v5_hybrid_h11_launch_treatment.ps1",
        "scripts/alpha_holdem/v5_rearm_watchers.ps1",
        "scripts/alpha_holdem/test_v5_hybrid_h11_implementation.py",
        "scripts/alpha_holdem/test_v5_hybrid_h11_control_plane.py",
        "scripts/alpha_holdem/test_v5_hybrid_h11_rearm_contract.py",
        "scripts/alpha_holdem/test_v5_hybrid_h11_judge_contract.py",
        "scripts/alpha_holdem/v5_hybrid_h11_preregistration_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h11_design_lock_build.py",
    ]
    ...
    fixed_files = [
        ...
        ROOT / "reports/v5_hybrid_h10_judgment_20260715.json",
        ROOT / "reports/v5_hybrid_h10_resource_isolation_incident_20260715.json",
        ...
        ROOT / "models/alpha_holdem_v5_hybrid/v5_hybrid_h8_treatment_kles003_vhcatch_same32617_20m_r1_20260714/h8_treatment_endpoint_status.json",
        ROOT / "reports/v5_hybrid_h8_judgment_20260714.json",
    ]
    lock = {
        "schema_version": "v5.hybrid.h11.design_lock.v1",
        "design_id": "H11",
        "status": "LOCKED",
        "locked_at": datetime.now(timezone.utc).isoformat(),
        "preregistration": frozen(PREREG),
        "preregistration_audit": frozen(PREREG_AUDIT),
        "implementation_audit": {**frozen(IMPLEMENTATION), "overall": implementation["overall"], "checks": "18/18 PASS; focused suite 12/12 PASS"},
        ...
        "source": {"path": str(SOURCE.resolve()), "sha256": source_sha, "iteration": 33834, "hands": 556011085, "run_id": prereg["source"]["run_id"], "role": prereg["source"]["role"]},
        "preregistration_source": {"checkpoint_path": str(SOURCE.resolve()), "checkpoint_sha256": source_sha},
        "source_anchor": {"path": str(SOURCE.resolve()), "sha256": source_sha, "iteration": 33834, "hands": 556011085, "run_id": prereg["source"]["run_id"]},
        "forbidden_sources": [{**item, "path": absolute(item["path"])} for item in prereg["forbidden_sources"]],
        "arm_budget": {"actual_hands_each": 20000000, "minimum_endpoint_hands": 576011085, "maximum_overshoot_hands": 50000, "order": ["control", "treatment"]},
        "arms": arm_values,
        ...
        "resource_isolation": {
            ...
            "allowed_project_processes": "EXACT_LOCKED_H11_LIFECYCLE_PLUS_EXISTING_PATH1_ONLY",
            ...
            "violation_classification": "H11_INCONCLUSIVE_RESOURCE_ISOLATION_VIOLATION",
        },
        "measurement": {
            ...
            "start_condition": "BOTH_H11_ENDPOINTS_FROZEN_PASS_AND_NO_TRAINER_ACTIVE",
        },
        "gates": {
