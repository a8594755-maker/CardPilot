...
SCRIPT = ROOT / "scripts/alpha_holdem/v5_hybrid_h16_health_watch.py"
SPEC = importlib.util.spec_from_file_location("h16_health", SCRIPT)
...
def test_prepare_view_is_exact_and_does_not_modify_source(tmp_path: Path) -> None:
    ...
    run_dir.mkdir()
    manifest = {"run_id": "h16", "iteration": 2, "total_hands": 3, "config": {"h16_window_arm": "control"}}
