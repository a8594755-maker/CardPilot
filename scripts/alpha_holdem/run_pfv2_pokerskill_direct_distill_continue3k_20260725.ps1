...
$checkpoint = "models/slumbot_br_pfv2_pokerskill_direct_distill_20260725/latest.pt"
$screenDir = "models/slumbot_br_pfv2_pokerskill_direct_distill_quick2k_20260725"
$runDir = "models/slumbot_br_pfv2_pokerskill_direct_distill_continue3k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 12; $part++) {
    $stem = "bench_v55_pfv2_pokerskill_direct_distill_cont_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
