"""Independent content audit for the one frozen RS004 qualification result."""
...
PREREG_SHA = "d6fd7ec547c7fcaee1f42f3a4e8074525ca86f1bc25ddf0aef197bc0dc374b2b"
...
PREREG_AUDIT_SHA = "b00417328f267021ab27e84f43c1210732c0d3a5b4c20fc13e22f8fccf18f258"
RUNNER = ROOT / "scripts" / "alpha_holdem" / f"v5_rs004_live_native_paired_mc32_{TOKEN}.py"
RUNNER_SHA = "3041e15ae0398579681d61995dd100d84297228200f8815d749b8e12407d315a"
...
def main() -> int:
    ...
    check("result_classification", result.get("classification") == "PASS / RS004_LIVE_NATIVE_QUALIFICATION_PASS")
    ...
    classification = "PASS / RS004_INDEPENDENT_RESULT_AUDIT_PASS_QUICK5K_ELIGIBLE" if passed == len(checks) else "FAIL_CLOSED / RS004_INDEPENDENT_RESULT_AUDIT_NONPASS_NO_QUICK5K"
    report = {
        "schema_version": "v5.rs004.qualification.result_audit.v1",
