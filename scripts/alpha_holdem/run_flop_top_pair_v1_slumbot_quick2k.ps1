...
$checkpoint = "models/slumbot_flop_top_pair_size_v1_20260725/flop_top_pair_slot3.pt"
$runDir = "models/slumbot_flop_top_pair_size_v1_greedy2k_retry_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "bench_v55_flop_top_pair_v1_retry_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
...
if ($successfulHands -lt 1900) {
    throw "flop-top-pair v1 quick2k produced only $successfulHands hands"
}
