#!/usr/bin/env python3
"""Duplicate-safe H13 control-to-treatment launch supervisor."""
from __future__ import annotations
import argparse,json,os,subprocess,time
from datetime import datetime,timezone
from pathlib import Path
RUN_ID='v5_hybrid_h13_treatment_catchsmoothl1b1_same35051_20m_r1_20260716'
def load(path):
...
def main():
 ...
 while True:
  ...
  endpoint=load(control/'h13_control_endpoint_status.json');protocol=load(control/'h13_control_protocol_status.json')
