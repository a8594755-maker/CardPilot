...
$checkpoint = "models/slumbot_br_stage4_pokerskill_sb_riverguard_v1_20260725/latest.pt"
$screenDir = "models/slumbot_br_stage4_pokerskill_sb_riverguard_v1_quick2k_20260725"
$runDir = "models/slumbot_br_stage4_pokerskill_sb_riverguard_v1_continue3k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 12; $part++) {
    $stem = "bench_stage4_pokerskill_sb_riverguard_v1_cont_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
