...
$checkpoint = "models/slumbot_br_stage4_pokerskill_preflop_v1_20260725/latest.pt"
$runDir = "models/slumbot_br_stage4_pokerskill_preflop_v1_quick2k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "bench_v55_stage4_pokerskill_preflop_v1_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
