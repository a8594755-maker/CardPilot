#!/usr/bin/env python3
"""Build the one-shot immutable H18 design lock after every offline gate passes."""
...
PREREG_AUDIT = REPORTS / "v5_hybrid_h18_preregistration_audit_20260719.json"
IMPLEMENTATION = REPORTS / "v5_hybrid_h18_implementation_audit_20260719.json"
INTEGRATION = REPORTS / "v5_h18_control_plane_integration_audit_20260719.json"
ROUTE_PREREG = REPORTS / "v5_hybrid_route_review_018_preregistration_20260719.json"
ROUTE_PREREG_AUDIT = REPORTS / "v5_hybrid_route_review_018_preregistration_audit_20260719.json"
ROUTE_RESULT = REPORTS / "v5_hybrid_route_review_018_result_20260719.json"
ROUTE_AUDIT = REPORTS / "v5_hybrid_route_review_018_result_audit_20260719.json"
PCV007_RESULT = REPORTS / "v5_pcv007_result_20260719.json"
PCV007_AUDIT = REPORTS / "v5_pcv007_result_audit_20260719.json"
...
MIRROR_DIR = REPORTS / "h18_mirror_001_v3_20260719"
...
def main() -> int:
    ...
    if args.out.exists():
        raise SystemExit("refusing to overwrite immutable H18 design lock")
    prereg = load(PREREG)
    ...
    if implementation.get("overall") != "PASS_H18_IMPLEMENTATION" or implementation.get("failed_checks"):
    ...
    if route_result.get("decision", {}).get("selected_next") != "H18_SEPARATELY_REGISTERED_TOLERANCE_AND_GPU_EVENT_PREARM_CORRECTION" or route_result.get("decision", {}).get("route_exhausted") is not False or route_audit.get("overall") != "PASS":
        raise SystemExit("Route Review018 authority missing")
    ...
    tools = [
        ...
        "scripts/alpha_holdem/v5_hybrid_h18_implementation_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h18_perf_cal.py",
        "scripts/alpha_holdem/v5_hybrid_h18_perf_cal_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h18_health_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h18_ordered_rearm.py",
        "scripts/alpha_holdem/v5_hybrid_h18_endpoint_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h18_protocol_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h18_treatment_launch_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h18_active_window.py",
        "scripts/alpha_holdem/v5_hybrid_h18_mirror.py",
        "scripts/alpha_holdem/v5_hybrid_h18_judge.py",
        "scripts/alpha_holdem/v5_hybrid_h18_completion_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h18_preflight.py",
        "scripts/alpha_holdem/v5_hybrid_h18_design_lock_audit.py",
        "scripts/alpha_holdem/v5_h18_control_plane_integration_audit.py",
        ...
        "scripts/alpha_holdem/v5_hybrid_h18_design_lock_build.py",
    ]
    ...
    mirror_lock_value = {
        "schema_version": "v5.hybrid.h18.mirror_lock.v1",
        "design_id": "H18-MIRROR-001",
        "status": "LOCKED",
        "locked_at": datetime.now(timezone.utc).isoformat(),
        "preregistration_sha256": PREREG_SHA,
        "manifest_sha256": sha(mirror_manifest),
        "tool_sha256": tool_hashes["scripts/alpha_holdem/v5_hybrid_h18_mirror.py"],
        "pairs": 40_000,
    ...
    if mirror_lock.exists():
        raise SystemExit("refusing pre-existing H18 mirror lock")
    ...
    fixed_files = [
        ...
        ROUTE_PREREG, ROUTE_PREREG_AUDIT, ROUTE_RESULT, ROUTE_AUDIT,
        PCV007_RESULT, PCV007_AUDIT,
    ...
    lock = {
        "schema_version": "v5.hybrid.h18.design_lock.v1",
        "design_id": "H18", "status": "LOCKED",
        "locked_at": datetime.now(timezone.utc).isoformat(),
        ...
        "implementation_audit": {**frozen(IMPLEMENTATION), "overall": "PASS_H18_IMPLEMENTATION", "checks": f'{len(implementation["checks"])}/{len(implementation["checks"])} PASS'},
        ...
        "route_review": {**frozen(ROUTE_RESULT), "preregistration": frozen(ROUTE_PREREG), "preregistration_audit": frozen(ROUTE_PREREG_AUDIT), "audit": frozen(ROUTE_AUDIT), "route_exhausted": False, "selected_next": "H18_SEPARATELY_REGISTERED_TOLERANCE_AND_GPU_EVENT_PREARM_CORRECTION"},
        "pcv007": {**frozen(PCV007_RESULT), "audit": frozen(PCV007_AUDIT), "classification": "PCV007_PASS_NUMERICAL_ENVELOPE_AND_GPU_EVENT_TIMING", "interpretation": "CONTROL_PLANE_ONLY"},
        ...
        "resource_isolation": {
            ...
            "allowed_project_processes": "EXACT_LOCKED_H18_LIFECYCLE_PLUS_EXISTING_EXACT_PATH1_ONLY",
            ...
            "violation_classification": "H18_INCONCLUSIVE_RESOURCE_ISOLATION_VIOLATION",
        },
        "measurement": {
            ...
            "start_condition": "BOTH_H18_ENDPOINTS_FROZEN_PASS_AND_NO_TRAINER_ACTIVE",
        },
        ...
        "launch_policy": {
            "current_authority": "NONE_CURRENT_HEARTBEAT",
            "launcher_requires_explicit_switch": "LaunchAuthorized",
            "validate_only_allowed": True,
            "future_launch_requires_new_explicit_operational_authority": True,
        },
