#!/usr/bin/env python3
"""Fresh LRFT-F8R1C1 kernels and zero-science resource admission.
...
IDENTITY = "80f4f9d2e7e6c7f4bc9f6dc82e7f2e896bd0c3ff56dd542eec58b239d1422619"
TOKEN = IDENTITY[:32]
SCIENCE_MASTER_IDENTITY = "b35078ee7ad2ab123d5f9b0770538793d14e7b9dfbdbb51cc7897df93e2d3198"
PARENT_RUNNER_SHA256 = "2922d9dc18566b361883da6a384a9349a4bddbf5e3f743f0952ba09bbcdd8506"
PREREG = ROOT / (
    "reports/v5_lrft_f8r1c1_runtime_metadata_correction_preregistration_"
    "80f4f9d2e7e6c7f4bc9f6dc82e7f2e89_20260723.json"
)
PREREG_SHA256 = "53b0bbfd1aceb511b7e027fc42e2e100cf6d680f989bf8e292ffd59bf1dccb08"
PREAUDIT = ROOT / (
    "reports/v5_lrft_f8r1c1_preregistration_audit_"
    "80f4f9d2e7e6c7f4bc9f6dc82e7f2e89_20260723.json"
)
PREAUDIT_SHA256 = "5857daa842330c7aa5448adce3c57d067b78c9c53ed6f91b0d875e7937a29eab"
IMPLEMENTATION_AUDITOR = ROOT / (
    "scripts/alpha_holdem/audit_v5_lrft_f8r1c1_"
    "80f4f9d2e7e6c7f4bc9f6dc82e7f2e89.py"
)
IMPLEMENTATION_AUDIT = ROOT / (
    "reports/v5_lrft_f8r1c1_implementation_audit_"
    "80f4f9d2e7e6c7f4bc9f6dc82e7f2e89_20260723.json"
)
IMPLEMENTATION_AUDIT_SCHEMA = "v5.lrft_f8r1c1.implementation_audit.v1"
...
OUTPUT_ROOT = ROOT / f"reports/lrft_f8r1c1_{TOKEN}"
...
class CounterRNG:
    ...
    def __init__(self, master: str = SCIENCE_MASTER_IDENTITY):
        if master != SCIENCE_MASTER_IDENTITY:
            raise ValueError("F8R1C1 master identity mismatch")
        self.master = master
...
def no_model_contracts() -> dict[str, bool]:
    ...
    if not all(checks.values()):
        ...
        raise AssertionError(f"F8R1C1 no-model contract failures: {failures}")
    return checks
...
def contract_probe(probe_root: Path) -> dict[str, Any]:
    ...
    return {
        "status": "LRFT_F8R1C1_CONTRACT_PROBE_PASS",
        "identity": IDENTITY,
...
def _measure_fixed_finalization() -> dict[str, Any]:
    ...
    payload = json_bytes(
        {
            "schema": "LRFT_F8R1C1_RESOURCE_FINALIZATION_PROBE_V1",
            "identity": IDENTITY,
            "padding": "0" * ((1 << 20) - 256),
        }
    )
    started = time.perf_counter()
    with tempfile.TemporaryDirectory(prefix="f8r1c1_finalization_") as directory:
...
def resource_admission(implementation_audit: Path) -> dict[str, Any]:
    ...
    def evidence_kernel(block: int) -> Mapping[str, int]:
        ...
        with tempfile.TemporaryDirectory(prefix="f8r1c1_resource_") as directory:
    ...
    result = {
        "schema_version": "v5.lrft_f8r1c1.resource_admission.v1",
        "identity": IDENTITY,
        "status": (
            "LRFT_F8R1C1_RESOURCE_ADMISSION_PASS_SCIENCE_SEPARATELY_AUTHORIZED"
            if passed
            else "LRFT_F8R1C1_RESOURCE_ADMISSION_NONPASS_NO_SCIENTIFIC_ROWS"
        ),
...
def main() -> int:
    ...
    if arguments.mode == "no-model-contracts":
        ...
        print(
            json.dumps(
                {
                    "status": "LRFT_F8R1C1_NO_MODEL_CONTRACTS_PASS",
                    "passed": sum(checks.values()),
                    "total": len(checks),
                    "checks": checks,
                },
