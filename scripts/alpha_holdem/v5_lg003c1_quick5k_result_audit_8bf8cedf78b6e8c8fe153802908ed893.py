#!/usr/bin/env python3
"""Independent exact evidence audit for an LG003C1 standard quick5k bundle."""
...
CHECKPOINT_SHA256 = {
    "control_uniform": "9c8f8033f92cb34291b62eb685761110026ee9afb5eb84e398caa03ea8f332ff",
    "treatment_diversity": "a504d118e4999e3a16e3efab552de368f088e7af2a1fede7d6c994440355efba",
}
CHECKPOINT_PATH = {
    "control_uniform": (
        "C:\\Users\\a8594\\CardPilot\\models\\alpha_holdem_v5_hybrid\\"
        "v5_lg003c1_8bf8cedf78b6e8c8fe153802908ed893_20260723\\"
        "control_uniform_stagea\\latest.pt"
    ),
    "treatment_diversity": (
        "C:\\Users\\a8594\\CardPilot\\models\\alpha_holdem_v5_hybrid\\"
        "v5_lg003c1_8bf8cedf78b6e8c8fe153802908ed893_20260723\\"
        "treatment_diversity_stagea\\latest.pt"
    ),
}
...
def main() -> int:
    ...
    check("dump_rows_exact", len(all_dump_rows) == 32117 if args.arm == "control_uniform" else len(all_dump_rows) > 0)
    ...
    result = {
        "schema_version": "v5.lg003c1.quick5k_result_audit.v1",
        ...
        "artifacts": artifacts,
        "next_authority": "REGISTERED_STAGE_A_TREATMENT_FROM_EXACT_H11_START"
        if not failed
