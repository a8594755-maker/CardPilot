...
$trainLog = 'reports\sourcev4_postflop_adapter128_rl_1m_20260726.stdout.log'
$model = 'models\sourcev4_postflop_adapter128_rl_1m_20260726\latest.pt'
    ...
    $trainer = @(
        Get-CimInstance Win32_Process |
            Where-Object {
                ...
                $_.CommandLine -match 'sourcev4_postflop_adapter128_rl_1m_20260726'
            }
    )
    if ($trainer.Count -eq 0 -and (Test-Path -LiteralPath $trainLog)) {
        throw 'Adapter 1M trainer exited without its completion line'
    }
...
if (
    ...
    throw 'Timed out waiting for adapter 1M training'
}

$curveDir = 'models\sourcev4_postflop_adapter128_rl_1m_20260726\internal_curve'
...
if ($LASTEXITCODE -ne 0) {
    throw 'Adapter 1M internal probe failed'
}

$externalDir = 'models\bench_sourcev4_postflop_adapter128_rl_1m_pure_fresh5k_20260726'
...
& powershell.exe -NoProfile -ExecutionPolicy Bypass -File `
    ...
    -Tag 'sourcev4_postflop_adapter128_rl_1m_pure_fresh5k_20260726' `
