#!/usr/bin/env python3
"""Duplicate-safe H11 control-to-treatment launch supervisor."""
from __future__ import annotations
import argparse,json,os,subprocess,time
from datetime import datetime,timezone
from pathlib import Path
RUN_ID='v5_hybrid_h11_treatment_catchsmoothl1b1_same33834_20m_r1_20260715'
def load(path):
...
def main():
 ...
 while True:
  ...
  endpoint=load(control/'h11_control_endpoint_status.json');protocol=load(control/'h11_control_protocol_status.json')
