...
$checkpoint = "models/slumbot_br_preflop_teacher_v13_smoke65k_20260725/latest.pt"
$runDir = "models/slumbot_br_preflop_teacher_v13_smoke_quick2k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "bench_v55_preflop_teacher_v13_smoke_q2k_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
