#!/usr/bin/env python3
"""Build the one-shot immutable H17 design lock after every offline gate passes."""
...
PREREG = REPORTS / "v5_hybrid_h17_preregistration_20260719.json"
PREREG_AUDIT = REPORTS / "v5_hybrid_h17_preregistration_audit_20260719.json"
IMPLEMENTATION = REPORTS / "v5_hybrid_h17_implementation_audit_20260719.json"
INTEGRATION = REPORTS / "v5_h17_control_plane_integration_audit_20260719.json"
ROUTE_RESULT = REPORTS / "v5_hybrid_route_review_015_result_20260719.json"
ROUTE_AUDIT = REPORTS / "v5_hybrid_route_review_015_result_audit_20260719.json"
...
MIRROR_DIR = REPORTS / "h17_mirror_001_v3_20260719"
HOLDOUT = REPORTS / "h1_cal_001_attempt2_20260712"
PREREG_SHA = "df256560d69928c9f70e6df5457c1575cc81124ba80f34f9b15261293cefe7fc"
...
def main() -> int:
    ...
    if args.out.exists():
        raise SystemExit("refusing to overwrite immutable H17 design lock")
    prereg = load(PREREG)
    ...
    if implementation.get("overall") != "PASS_H17_IMPLEMENTATION" or implementation.get("failed_checks"):
    ...
    if route_result.get("decision", {}).get("selected_next") != "H17_CORRECTED_DETERMINISTIC_TRIGGER_SAME_SCIENCE_BASELINE_SMOOTHL1_KERNEL" or route_result.get("decision", {}).get("route_exhausted") is not False or route_audit.get("overall") != "PASS":
        raise SystemExit("Route Review015 authority missing")
    ...
    tools = [
        ...
        "scripts/alpha_holdem/v5_hybrid_h17_implementation_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h17_perf_cal.py",
        "scripts/alpha_holdem/v5_hybrid_h17_perf_cal_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h17_health_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h17_ordered_rearm.py",
        "scripts/alpha_holdem/v5_hybrid_h17_endpoint_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h17_protocol_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h17_treatment_launch_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h17_active_window.py",
        "scripts/alpha_holdem/v5_hybrid_h17_mirror.py",
        "scripts/alpha_holdem/v5_hybrid_h17_judge.py",
        "scripts/alpha_holdem/v5_hybrid_h17_completion_watch.py",
        "scripts/alpha_holdem/v5_hybrid_h17_preflight.py",
        "scripts/alpha_holdem/v5_hybrid_h17_design_lock_audit.py",
        "scripts/alpha_holdem/v5_h17_control_plane_integration_audit.py",
        "scripts/alpha_holdem/v5_hybrid_h17_launch_control.ps1",
        "scripts/alpha_holdem/v5_hybrid_h17_launch_treatment.ps1",
        "scripts/alpha_holdem/v5_rearm_watchers.ps1",
        "scripts/alpha_holdem/v5_hybrid_h17_design_lock_build.py",
    ]
    ...
    mirror_lock_value = {
        "schema_version": "v5.hybrid.h17.mirror_lock.v1",
        "design_id": "H17-MIRROR-001",
        "status": "LOCKED",
        "locked_at": datetime.now(timezone.utc).isoformat(),
        "preregistration_sha256": PREREG_SHA,
        "manifest_sha256": sha(mirror_manifest),
        "tool_sha256": tool_hashes["scripts/alpha_holdem/v5_hybrid_h17_mirror.py"],
        "pairs": 40_000,
    ...
    if mirror_lock.exists():
        raise SystemExit("refusing pre-existing H17 mirror lock")
    ...
    lock = {
        "schema_version": "v5.hybrid.h17.design_lock.v1",
        "design_id": "H17", "status": "LOCKED",
        "locked_at": datetime.now(timezone.utc).isoformat(),
        ...
        "implementation_audit": {**frozen(IMPLEMENTATION), "overall": "PASS_H17_IMPLEMENTATION", "checks": f'{len(implementation["checks"])}/{len(implementation["checks"])} PASS'},
        ...
        "route_review": {**frozen(ROUTE_RESULT), "audit": frozen(ROUTE_AUDIT), "route_exhausted": False, "selected_next": "H17_CORRECTED_DETERMINISTIC_TRIGGER_SAME_SCIENCE_BASELINE_SMOOTHL1_KERNEL"},
        ...
        "resource_isolation": {
            ...
            "allowed_project_processes": "EXACT_LOCKED_H17_LIFECYCLE_PLUS_EXISTING_EXACT_PATH1_ONLY",
            ...
            "violation_classification": "H17_INCONCLUSIVE_RESOURCE_ISOLATION_VIOLATION",
        },
        "measurement": {
            ...
            "start_condition": "BOTH_H17_ENDPOINTS_FROZEN_PASS_AND_NO_TRAINER_ACTIVE",
        },
