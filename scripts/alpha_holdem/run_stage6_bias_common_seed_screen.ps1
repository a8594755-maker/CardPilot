...
$candidates = @(
    ...
    @{
        Name = "bias75"
        Checkpoint = "models/slumbot_br_progressive_ranges_stage6_iter20_bias75_20260725.pt"
    },
    @{
        Name = "bias65"
        Checkpoint = "models/slumbot_br_progressive_ranges_stage6_iter20_bias65_20260725.pt"
    }
)

foreach ($candidate in $candidates) {
    $runName = "localgreedy_stage6_iter20_$($candidate.Name)_bias_screen_131k_20260725"
