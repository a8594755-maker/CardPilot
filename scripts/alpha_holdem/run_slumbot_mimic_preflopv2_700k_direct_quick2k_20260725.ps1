...
$checkpoint = "models/slumbot_mimic_preflopv2_700k_20260725/best.pt"
$runDir = "models/slumbot_mimic_preflopv2_700k_direct_quick2k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "slumbot_mimic_direct_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
...
if ($successfulHands -lt 1900) {
    throw "Direct Slumbot-mimic quick2k produced only $successfulHands hands"
}
