...
def main():
    ...
    if args.resume and os.path.exists(args.resume):
        ...
        prior_warmup_state = ckpt.get('exp_w1_value_warmup')
        if isinstance(prior_warmup_state, dict) and prior_warmup_state.get('status') == 'PASS':
            exp_w1_warmup_state = dict(prior_warmup_state)
