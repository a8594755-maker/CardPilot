...
SCRIPT = ROOT / "scripts/alpha_holdem/v5_hybrid_h14_perf_cal.py"
SPEC = importlib.util.spec_from_file_location("h14_perf", SCRIPT)
...
def test_deterministic_batch_and_hash() -> None:
    left = MODULE.deterministic_batch(2026071701, 8)
    right = MODULE.deterministic_batch(2026071701, 8)
