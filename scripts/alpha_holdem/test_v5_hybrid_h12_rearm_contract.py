...
def test_h12_rearm_validate_only_classifies_and_blocks_generic_paths() -> None:
...
def test_h12_strict_rearm_contains_only_locked_lifecycle_launches() -> None:
    source = REARM.read_text(encoding="utf-8-sig")
    required = (
        "if ($script:isHybridH12Arm)",
        ...
        "reports/v5_hybrid_h12_design_lock_v2_20260716.json",
    )
