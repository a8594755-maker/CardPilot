#!/usr/bin/env python3
"""Independent fail-closed audit for H15 PERF-CAL artifacts."""
...
from v5_hybrid_h15_perf_cal import (
...
def main() -> int:
    ...
    check("schema", artifact.get("schema_version") == "v5.hybrid.h15.perf_cal.v1")
    check("overall_pass", artifact.get("overall") == "PASS" and artifact.get("classification") == "H15_PERF_CAL_PASS")
    ...
    payload = {
        "schema_version": "v5.hybrid.h15.perf_cal_audit.v1",
