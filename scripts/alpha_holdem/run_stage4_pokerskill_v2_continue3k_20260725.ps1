...
$checkpoint = "models/slumbot_br_stage4_pokerskill_v2_20260725/latest.pt"
$screenDir = "models/slumbot_br_stage4_pokerskill_v2_quick2k_20260725"
$runDir = "models/slumbot_br_stage4_pokerskill_v2_continue3k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 12; $part++) {
    $stem = "bench_stage4_pokerskill_v2_cont_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
