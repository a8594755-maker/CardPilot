...
def test_h9_mse_mode_is_bitwise_equivalent_to_h8_catchup_default() -> None:
...
def test_h9_smooth_l1_changes_only_value_head_catchup_effect() -> None:
...
def test_h9_cli_contract_is_fail_closed_in_source() -> None:
    source = open("scripts/alpha_holdem/train_v5.py", encoding="utf-8").read()
    required = (
        "--h9-window-arm",
        "--h9-catchup-loss",
        "--h9-catchup-smooth-l1-beta",
