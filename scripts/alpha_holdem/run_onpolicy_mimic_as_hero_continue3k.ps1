...
$screenDir = "models/slumbot_imitation_stage4_onpolicy_v2_as_hero_quick2k_20260725"
$runDir = "models/slumbot_imitation_stage4_onpolicy_v2_as_hero_continue3k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 12; $part++) {
    $stem = "bench_v55_onpolicy_mimic_as_hero_cont_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
