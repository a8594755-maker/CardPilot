...
$checkpoint = "models/slumbot_br_preflopv2_direct_v2_bb_tailfold_20260725/latest.pt"
$screenDir = "models/slumbot_br_preflopv2_direct_v2_bb_tailfold_quick2k_20260725"
$runDir = "models/slumbot_br_preflopv2_direct_v2_bb_tailfold_continue3k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 12; $part++) {
    $stem = "bench_preflopv2_direct_v2_bb_tailfold_cont_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
