...
$runDir = "models/slumbot_flop_top_pair_size_v1_greedy3k_ext_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "bench_v55_flop_top_pair_v1_ext3k_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
...
if ($successfulHands -lt 2850) {
    throw "flop-top-pair v1 extension produced only $successfulHands hands"
}
