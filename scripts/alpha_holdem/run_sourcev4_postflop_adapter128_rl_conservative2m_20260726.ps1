...
$runDir = 'models\sourcev4_postflop_adapter128_rl_conservative2m_20260726'
...
$args = @(
    ...
    '--run-id', 'sourcev4_postflop_adapter128_rl_conservative2m_20260726',
    '--run-dir', $runDir,
    '--out', (Join-Path $runDir 'latest.pt'),
    '--seed', '20260756',
    '--max-runtime-seconds', '21600',
    '--resume',
    'models/sourcev4_postflop_adapter128_rl_1m_20260726/latest.pt',
    '--allow-resume'
)
& python @args
exit $LASTEXITCODE
