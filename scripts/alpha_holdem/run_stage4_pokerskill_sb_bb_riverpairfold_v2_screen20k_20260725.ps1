...
$runDir = "models/slumbot_br_stage4_pokerskill_sb_bb_riverpairfold_v2_screen20k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 32; $part++) {
    $stem = "pokerskill_sb_bb_riverpairfold_v2_20k_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
...
if ($successfulHands -lt 19000) {
    throw "River pair-fold 20k screen produced only $successfulHands hands"
}
