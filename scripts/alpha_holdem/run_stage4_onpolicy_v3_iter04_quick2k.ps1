...
$checkpoint = "models/slumbot_br_stage4_onpolicy_v3_1m_20260725/checkpoints/checkpoint_iter000004_hands000000131535.pt"
$runDir = "models/slumbot_br_stage4_onpolicy_v3_iter04_quick2k_20260725"
New-Item -ItemType Directory -Force -Path $runDir | Out-Null

$processes = @()
for ($part = 1; $part -le 8; $part++) {
    $stem = "bench_v55_stage4_onpolicy_v3_iter04_part$part"
    $arguments = @(
        "-X", "utf8", "-u",
