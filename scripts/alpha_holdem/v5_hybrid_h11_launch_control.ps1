...
$runId='v5_hybrid_h11_control_catchmse_same33834_20m_r1_20260715'
...
$preflight=(Resolve-Path 'reports/v5_hybrid_h11_preflight_20260715.json').Path
...
$ready=$pf.overall -eq 'PASS_READY_H11_CONTROL_LAUNCH' -and $pf.design_lock_sha256 -eq $expected -and $path1 -and $path1.PriorityClass -eq 'BelowNormal' -and (-not(Test-Path $runDir))
...
[pscustomobject]@{status='H11_CONTROL_LAUNCHED_REARM_PASS';trainer_pid=$trainer.Id;run_id=$runId;design_lock_sha256=$expected;path1_pid=37656}|ConvertTo-Json
