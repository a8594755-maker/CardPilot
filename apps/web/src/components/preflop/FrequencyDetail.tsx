...
import { getActionColor, getActionLabel, type SpotSolution } from '../../data/preflop-loader';
...
export const FrequencyDetail = memo(function FrequencyDetail({
  solution,
  selectedHand,
}: FrequencyDetailProps) {
  ...
  return (
    <div className="space-y-3">
      ...
      <div>
        ...
        {selectedHand && (
          <p className="text-[10px] text-slate-500 mt-0.5">{handClassDescription(selectedHand)}</p>
        )}
        {!selectedHand && (
      ...
      {!selectedHand && (
        <div className="grid grid-cols-2 gap-2 pt-2 border-t border-slate-700/50">
          ...
          {solution.villainPosition && <StatBox label="Villain" value={solution.villainPosition} />}
