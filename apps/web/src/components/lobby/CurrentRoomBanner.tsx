    ...
    <div className="cp-lobby-card" style={{ borderColor: "rgba(251, 191, 36, 0.2)" }}>
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex items-center gap-2 sm:ml-auto shrink-0">
          <button onClick={onCopyCode} className="cp-btn cp-btn-ghost text-xs px-3" style={{ minHeight: 36 }}>
            Copy Code
          </button>
          <button onClick={onGoToTable} className="cp-btn cp-btn-success text-xs px-4 font-semibold" style={{ minHeight: 36 }}>
            Go to Table
          </button>
          <button onClick={onLeave} className="cp-btn cp-btn-ghost text-xs px-3" style={{ minHeight: 36, borderColor: "rgba(239, 68, 68, 0.2)", color: "#f87171" }}>
            Leave
          </button>
        </div>
      </div>
