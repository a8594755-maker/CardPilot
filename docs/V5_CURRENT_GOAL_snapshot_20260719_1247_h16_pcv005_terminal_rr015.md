...
Checked: 2026-07-19T16:16:00+00:00

## Authoritative operational update: H15 terminal;Route Review013 selects registered H16

- H15 is permanently `FAIL / H15_FAIL_PREARM_PERF_CAL_NO_LAUNCH`. Production
  control PERF-CAL SHA
  `eda4118250289b885a42be3dacd07931bb71506e7ea9bfdc3cd1183f89347379`
  measured MSE 0.0060538200 s/step versus SmoothL1 0.0065108400 s/step,ratio
  0.9298062924 below the registered 0.95 loss-only gate. The launcher stopped before
  sentinel,arm directory or trainer. Judgment/terminal-audit SHAs
  `b182ce5990788029807b59df7de21e0ea4685277b2d11df96a57fbef2499ccda` /
  `d19f1d85b70002c9a5a221a70bca9cd4d995984f1c3e3fb8becd9eba523405ee`
  PASS28/28. Never rerun,resume,extend,reclassify or infer method/strength from H15.
- Route Review013 result/audit SHAs
  `e54aa329e6e9a8d4770b24457db7584a8bb07e8046a9882870d33f52d4d18762` /
  `8974bc784cd8840eba7daa1ea1904fab199a4883f02ed3ab24308647c6cfef20`
  PASS17/17 select H16;route_exhausted=false. The only supported H15 conclusion is
  7.019% overhead in the loss-only microbenchmark. There is no end-to-end throughput
  or scientific evidence. H16 prospectively uses a representative full PPO update
  prearm calibration aligned with the unchanged first60/full 0.85 arm gates.
- H16 preregistration/audit SHAs
  `51065761b6b291ef757ea467611203cbe79d45a5e4d54c163edaf79ef8fa1bb0` /
  `945bb6bbcc0c8a533d78fde3fb9d6200d9daa0b288c96a42cee6d50fb2695136`
  PASS22/22. It retains exact H11 source iter35051 /576,021,901,fresh fixed20M
  MSE control then SmoothL1-beta1 treatment,and every scientific gate. Launch is
  `REGISTERED_NO_LAUNCH` pending implementation/audit,lock,preflight,representative
  PERF-CAL and canonical rearm. A failed representative calibration routes to PCV005
  through Route Review014. Path-1 remains untouched;official hands0 and L0 unchanged.

The H14-terminal/H15-ready section below is historical and has no authority.
